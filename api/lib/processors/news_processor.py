from api.lib.processors.news_fetcher import NewsFetcher
from api.lib.processors.article_processor import ArticleProcessor
...
from api.lib.core.data_handler import DataHandler
