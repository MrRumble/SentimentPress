...
with our pre determined keywords. It also gives the option to quickly insert othe keywords into the
...
class NewsCategoryPopulator:
    ...
    def populate_database(self):
        ...
        for category in self.categories:
            ...
            response_data_front_end, search_result = self.processor.process_query(category, 'ADMIN_JAMES')
    ...
    def add_custom_query(self):
        ...
        response_data_front_end, search_result = self.processor.process_query(custom_query, 'ADMIN')
        self.processor.save_search_result_to_db(search_result)
        end_time = time.time() 
        duration = end_time - start_time
